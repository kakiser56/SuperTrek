...
## Category
Primary: Games / Strategy. Secondary: Games / Simulation.

## Age rating answers
Cartoon or fantasy violence: Infrequent/Mild (text-based space combat). Everything else: None. Expected rating: 9+.

## App privacy
Data not collected. The app has no network access and no analytics.

## Support URL
https://kkiserapps.com/app-support
...
- Screenshots: 6.9-inch and 6.5-inch iPhone sets. The launch arguments -autoFixture battle, -autoPanel nav, and -autoPanel torpedo stage good frames.
